...
\usepackage[paperwidth=29cm,paperheight=12.5cm,top=0cm,bottom=0cm,left=0cm,right=0cm]{geometry} %%% Dimensions set to fit cover photo
...
%%% THIS FINE CONTAINS ONLY THE CODE FOR THE COVER PHOTO. SEE MAIN FILE FOR THE FULL CODE %%%

\begin{document}

\begin{center}
\begin{tikzpicture}[diagram1/.pic={%%% Urysohn's Lemma (this cannot be drawn in the main body as it is a tikz3d picture)
...
\draw (0,-3) pic[scale=1.2]{diagram1}; %code defined earlier in tikzpicture options
